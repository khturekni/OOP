...
public class CasaDeBurritoTest {
    ...
    public void RatingsTest() {
        ...
        CasaDeBurrito pp = new CasaDeBurritoImpl(10, "Italiano", 125, traditional_pizzas);
        Profesor lovers[] = {
                new ProfesorImpl(12345, "Leonardo"),
                new ProfesorImpl(23456, "Donatello"),
                new ProfesorImpl(56789, "Michelangelo"),
                new ProfesorImpl(45678, "Rafael"),
        };
    ...
    public void EqualsTest() {
        CasaDeBurrito italiano =               new CasaDeBurritoImpl(10, "Italiano", 125, traditional_pizzas);
        CasaDeBurrito italianoSameEverything = new CasaDeBurritoImpl(10, "Italiano", 125, traditional_pizzas);
        CasaDeBurrito italianoSameIdOnly =     new CasaDeBurritoImpl(10, "Totally not Italiano", 11250, complements);
        CasaDeBurrito dominos =                new CasaDeBurritoImpl(30, "Dominos", 650, meat_topping_pizzas);
        CasaDeBurrito noSuchPlace = null;
        ...
        assertFalse(italiano.equals(new ProfesorImpl(italiano.getId(), "Pizzza lover, not a place")));
    ...
    public void ToStringTest() {
        ...
        String p1Expected = "CasaDeBurrito: Italiano.\n" +
                "Id: 10.\n" +
                "Distance: 125.\n" +
